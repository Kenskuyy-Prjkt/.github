### Poco F4 / Redmi K40S device trees, vendor and kernel

## Repositories that you may need to clone:
* [Munch Device Tree](https://github.com/Kenskuyy-Prjkt/android_device_xiaomi_munch) (device/xiaomi/munch)
...
* [Hardware_dolby](https://github.com/Kenskuyy-Prjkt/android_hardware_dolby) (hardware/dolby)

## Dolby Atmos
* If you dont want to add Dolby Atmos: In device.mk, set ```TARGET_USES_DOLBY := flase```

## Telegram Device Group:
- [**Group**](https://t.me/kenskuyyplayground)
...
## Credit
LineageOS, Hdzungx, All sm8250 dev...